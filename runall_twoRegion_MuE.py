...
# Pipeline files
# Intercept MuTauE -> MuE
MUTAUE_81To101_PIPELINE = "./pipeline_mue_81To101.json"
ETAUMU_81To101_PIPELINE = "./pipeline_etaumu_81To101.json"
MUTAUE_21To81_PIPELINE = "./pipeline_mue_21To81.json"
...
if SIGNAL_TYPE == "ZH":
    ...
    for mass in MASS_RANGE:
        SIGNAL_PATHS["mutaue_81To101"][mass] = f"/work/project/escience/ruttho/FCC-ee_SimpleDelphesAnalysis/EventSample/ISR_HEMu_LFV/Hmass{mass}/ROOT/"
        SIGNAL_PATHS["etaumu_81To101"][mass] = f"/work/project/physics/psriling/FCC/FCCee/ISR_HETauMu_LFV/Hmass{mass}/ROOT/"
        SIGNAL_PATHS["mutaue_21To81"][mass] = f"/work/project/escience/ruttho/FCC-ee_SimpleDelphesAnalysis/EventSample/ISR_HEMu_LFV/Hmass{mass}/ROOT/"
    ...
    for mass in MASS_RANGE:
        SIGNAL_PATHS["mutaue_81To101"][mass] = f"/work/project/physics/vwachira/fcc-ee-higgs-lfv/delphes_outputs/mh{mass}_emu/"
        SIGNAL_PATHS["etaumu_81To101"][mass] = f"/work/project/physics/vwachira/fcc-ee-higgs-lfv/delphes_outputs/mh{mass}_etau/"
        SIGNAL_PATHS["mutaue_21To81"][mass] = f"/work/project/physics/vwachira/fcc-ee-higgs-lfv/delphes_outputs/mh{mass}_emu/"
